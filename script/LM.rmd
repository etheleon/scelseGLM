---
title: "LM"
author: Wesley GOI, Ezequiel (Ziggy) Marzinelli 
...
```{r collinear, echo=FALSE}
#pairs(Birds[,c("LOGAREA","LOGDIST","LOGLDIST","YR.ISOL","ALT","GRAZE")])
# Or
...
```{r results='asis', echo=FALSE}
drop1(M3, test = "F") %>% stargazer(type='html')
```
...
```{r results='asis', echo=FALSE}
drop1(M4, test = "F") %>% stargazer(type='html')
```
...
```{r results='asis', echo=FALSE}
drop1(M5, test = "F") %>% stargazer(type='html')
```
